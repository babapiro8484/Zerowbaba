...
menu_cpm1 = requests.get(f"{mode_server}/get_menu").json()
menu_cpm2 = requests.get(f"{mode_server}/get_menu_cpm2").json()
                ...
                while True:
                    ...
                    for x,v in enumerate(menu_cpm1):
                        ...
                        if v['status']=="active":
                            ...
                            menus1+=f"  [ğŸ”§] {v['nama_item']}\t\t[{v['harga_item']}]\n"
                    menus1+="  [q] Back"
                ...
                while True:
                    ...
                    for x,v in enumerate(menu_cpm2):
                        ...
                        if v['status']=="active":
                            ...
                            menus2+=f"  [ğŸ”§] {v['nama_item']}\t\t[{v['harga_item']}]\n"
                    menus2+="  [q] Back"
